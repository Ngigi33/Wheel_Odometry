...
//             lotation = 1;
//         }
//         else if (new_rot_A < 0 && new_rot_B > 0)
//         {
//             lotation = -1;
//         }
//         else if (new_rot_A == 0 || new_rot_B == 0)
...
//         if (lotation == 1)
//         {
//             delta_Orientation = (2 * distance_A) / distance_btwn_wheels;
...
//         else if (lotation == -1)
//         {
//             delta_Orientation = (2 * distance_B) / distance_btwn_wheels;
//             delta_X = distance_Avg * cos(old_Orientation + (delta_Orientation / 2.0));
//             delta_Y = distance_Avg * sin(old_Orientation + (delta_Orientation / 2.0));
//         }
//         else
...
private:
    ...
    void odom()
    {
        ...
        // RCLCPP_INFO(this->get_logger(), "Distance_A=%f....Distance_B=%f..... Current_Distance=%f", distance_A, distance_B, current_distance);
        // RCLCPP_INFO(this->get_logger(), "Distance moved=%f", current_distance);
        RCLCPP_INFO(this->get_logger(), "rotA=%.3f rotB=%.3f oren=%.3f Doren=%.3f", delta_rot_A, delta_rot_B, old_Orientation, delta_Orientation);
        // old_distance = current_distance;
    }
};
